...
DetFrames = cms.EDProducer('DetFrameProducer'
   ...
   #, vertexCollection = cms.InputTag("offlinePrimaryVerticesWithBS")
    ...
    , doTracksAtECALstitchedPt = cms.bool(False)
    , doTracksAtECALadjPt = cms.bool(False)
    , doHBHEenergy = cms.bool(False)
    , doBPIX1 = cms.bool(False)
    , doBPIX2 = cms.bool(False)
    , doBPIX3 = cms.bool(False)
    , doBPIX4 = cms.bool(False)
    , doTOB = cms.bool(False)
    , doTIB = cms.bool(False)
    , doTEC = cms.bool(False)
    , doTID = cms.bool(False)
    #, setChannelOrder = cms.string("0,1,2,3,4,5,6,7")
    , setChannelOrder = cms.string("0")
    )
